    ...
    public class VoucherController : ApiController
    {
        ...
        public HttpResponseMessage Get()
        {
            ...
            {                
                ...
                using (var objModel = new Voucher() { sCompanyID = sCompanyID, sCompanyLicense = sCompanyLicense, sRequesterUserName = sRequesterUserName, sRequesterPassword = sRequesterPassword, sRequesterControlID = sRequesterControlID })
                {
