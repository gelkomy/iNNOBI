...
{
    public class DerivedController : ApiController
    {
        [HttpGet]
        [DeflateCompression]
        public HttpResponseMessage Get()
        {
            ...
            {                
                ...
                if (string.IsNullOrEmpty(sCompanyID) || string.IsNullOrEmpty(sCompanyLicense))
                {
                ...
                using (var objModel = new Derived() { sCompanyID = sCompanyID, sCompanyLicense = sCompanyLicense, sRequesterUserName = sRequesterUserName, sRequesterPassword = sRequesterPassword, sRequesterControlID = sRequesterControlID })
                {
